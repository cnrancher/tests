...
type HostedCCEClusterProvisioningTestSuite struct {
	suite.Suite
...
func (h *HostedCCEClusterProvisioningTestSuite) TearDownSuite() {
	h.session.Cleanup()
}

func (h *HostedCCEClusterProvisioningTestSuite) SetupSuite() {
...
func (h *HostedCCEClusterProvisioningTestSuite) TestProvisioningHostedCCE() {
	tests := []struct {
		name   string
		client *rancher.Client
	}{
...
func TestHostedCCEClusterProvisioningTestSuite(t *testing.T) {
	suite.Run(t, new(HostedCCEClusterProvisioningTestSuite))
}
